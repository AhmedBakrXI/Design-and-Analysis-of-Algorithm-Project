...
public:
    ...
    // Overloading the less than operator to compare moves based on heuristic score
    bool operator<(const Move& other) const {
        return totalHeuristicDifference < other.totalHeuristicDifference;
    }
private:
	...
	string knight;
public:
    int getTotalHeuristicDifference() const {
        return totalHeuristicDifference;
    }

    void setTotalHeuristicDifference(int totalHeuristicDifference) {
        Move::totalHeuristicDifference = totalHeuristicDifference;
    }

private:
    PossibleMoves possibleMovesList;

    int totalHeuristicDifference;
};// class Move
